...
public class AlertDialogLayout extends pw4 {
        ...
        if (mode2 != 1073741824) {
            ...
            while (i9 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) ow4Var).width == -1) {
                        int i10 = ((LinearLayout.LayoutParams) ow4Var).height;
                        ((LinearLayout.LayoutParams) ow4Var).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, iMakeMeasureSpec, 0, i8, 0);
                        ((LinearLayout.LayoutParams) ow4Var).height = i10;
                    }
                }
                i9++;

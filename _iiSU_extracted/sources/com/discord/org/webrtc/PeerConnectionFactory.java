...
import com.discord.org.webrtc.NativeLibrary;
import com.discord.org.webrtc.PeerConnection;
import com.discord.org.webrtc.audio.AudioDeviceModule;
...
public class PeerConnectionFactory {
    ...
    public PeerConnectionFactory(long j) {
        ...
        if (j != 0) {
            ...
            ob2.j("Failed to initialize PeerConnectionFactory!");
            throw null;
        }
    }
    ...
    public static void checkInitializeHasBeenCalled() {
        if (!NativeLibrary.isLoaded() || ContextUtils.getApplicationContext() == null) {
            ff1.n("PeerConnectionFactory.initialize was not called before creating a PeerConnectionFactory.");
        }
    }
    ...
    private void checkPeerConnectionFactoryExists() {
        ...
        ff1.n("PeerConnectionFactory has been disposed.");
    }
    ...
    private static void printStackTrace(ThreadInfo threadInfo, boolean z) {
        ...
        if (z) {
            Logging.w(TAG, "*** *** *** *** *** *** *** *** *** *** *** *** *** *** *** ***");
            StringBuilder sbQ = j55.q("pid: ", Process.myPid(), ", tid: ", threadInfo.tid, ", name: ");
            sbQ.append(name);
            sbQ.append("  >>> WebRTC <<<");
            Logging.w(TAG, sbQ.toString());
    ...
    public static class Builder {
        ...
        public Builder setAudioDecoderFactoryFactory(AudioDecoderFactoryFactory audioDecoderFactoryFactory) {
            ...
            ff1.j("PeerConnectionFactory.Builder does not accept a null AudioDecoderFactoryFactory.");
            return null;
        }
        ...
        public Builder setAudioEncoderFactoryFactory(AudioEncoderFactoryFactory audioEncoderFactoryFactory) {
            ...
            ff1.j("PeerConnectionFactory.Builder does not accept a null AudioEncoderFactoryFactory.");
            return null;
        }

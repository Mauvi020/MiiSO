...
public class FileVideoCapturer implements VideoCapturer {
    ...
    private final TimerTask tickTask = new TimerTask() { // from class: com.discord.org.webrtc.FileVideoCapturer.1
    ...
    public static class VideoReaderY4M implements VideoReader {
        ...
        public VideoReaderY4M(String str) throws IOException {
            ...
            while (true) {
                ...
                if (i == -1) {
                    ob2.j(pk0.i("Found end of file before end of header for file: ", str));
                    throw null;
                }
                if (i == 10) {
                    ...
                    if (!strSubstring.equals("420") && !strSubstring.equals("420mpeg2")) {
                        ff1.j("Does not support any other color space than I420 or I420mpeg2");
                        throw null;
                    }
                    if (i2 % 2 == 1 || i3 % 2 == 1) {
                        ff1.j("Does not support odd width or height");
                        throw null;
                    }
                    this.frameWidth = i2;
                    this.frameHeight = i3;
                    Logging.d(TAG, j55.i("frame dim: (", i2, ", ", i3, ")"));
                    return;
                }
                sb.append((char) i);
            }
        ...
        @Override // com.discord.org.webrtc.FileVideoCapturer.VideoReader
        public void close() {
            try {

...
public class GlShader {
    ...
    public GlShader(String str, String str2) {
        ...
        if (iGlCreateProgram == 0) {
            ob2.j(f33.h(GLES20.glGetError(), "glCreateProgram() failed. GLES20 error: "));
            throw null;
        }
        ...
        if (iArr[0] == 1) {
            ...
            ob2.j(GLES20.glGetProgramInfoLog(this.program));
            throw null;
        }
    }
    ...
    private static int compileShader(int i, String str) {
        ...
        if (iGlCreateShader == 0) {
            ob2.j(f33.h(GLES20.glGetError(), "glCreateShader() failed. GLES20 error: "));
            return 0;
        }
        ...
        ob2.j(GLES20.glGetShaderInfoLog(iGlCreateShader));
        return 0;
    }
    ...
    public int getAttribLocation(String str) {
        int i = this.program;
        if (i == -1) {
            ob2.j("The program has been released");
            return 0;
        }
        ...
        ob2.j(pk0.j("Could not locate '", str, "' in program"));
        return 0;
    }
    ...
    public int getUniformLocation(String str) {
        ...
        ob2.j(pk0.j("Could not locate uniform '", str, "' in program"));
        return 0;
    }

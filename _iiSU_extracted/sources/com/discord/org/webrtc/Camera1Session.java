...
class Camera1Session implements CameraSession {
    ...
    /* JADX INFO: renamed from: com.discord.org.webrtc.Camera1Session$2, reason: invalid class name */
    /* JADX INFO: compiled from: r8-map-id-2a50c0369e92087812e54748034d27ec95c033a3a5145ed80421924f55507ca7 */
    public class AnonymousClass2 implements Camera.PreviewCallback {
        ...
        public /* synthetic */ void lambda$onPreviewFrame$1(byte[] bArr) {
            Camera1Session.this.cameraThreadHandler.post(new b(0, this, bArr));
        }
        ...
        public void onPreviewFrame(byte[] bArr, Camera camera) {
            ...
            VideoFrame videoFrame = new VideoFrame(new NV21Buffer(bArr, Camera1Session.this.captureFormat.width, Camera1Session.this.captureFormat.height, new b(1, this, bArr)), Camera1Session.this.getFrameOrientation(), nanos);
    ...
    private void startCapturing() {
        ...
        this.camera.setErrorCallback(new Camera.ErrorCallback() { // from class: com.discord.org.webrtc.Camera1Session.1
            @Override // android.hardware.Camera.ErrorCallback
            public void onError(int i, Camera camera) {
                String strH = i == 100 ? "Camera server died!" : f33.h(i, "Camera error: ");
                ...
                if (i == 2) {
                    ...
                    camera1Session.events.onCameraError(Camera1Session.this, strH);
                }
            }
        });
    ...
    @Override // com.discord.org.webrtc.CameraSession
    public void stop() {

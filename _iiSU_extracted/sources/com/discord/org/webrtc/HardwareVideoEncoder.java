...
class HardwareVideoEncoder implements VideoEncoder {
    ...
    private Thread createOutputThread() {
        return new Thread() { // from class: com.discord.org.webrtc.HardwareVideoEncoder.1
    ...
    /* JADX WARN: Removed duplicated region for block: B:28:0x00a5 A[Catch: IllegalArgumentException | IllegalStateException -> 0x009b, IllegalArgumentException | IllegalStateException -> 0x009b, TryCatch #0 {IllegalArgumentException | IllegalStateException -> 0x009b, blocks: (B:9:0x002d, B:11:0x0066, B:15:0x0075, B:15:0x0075, B:28:0x00a5, B:28:0x00a5, B:20:0x0084, B:20:0x0084, B:22:0x008c, B:22:0x008c, B:25:0x009e, B:25:0x009e, B:29:0x00ac, B:29:0x00ac, B:31:0x00b7, B:31:0x00b7, B:32:0x00bc, B:32:0x00bc, B:34:0x00c2, B:34:0x00c2, B:35:0x00c9, B:35:0x00c9, B:37:0x00e2, B:37:0x00e2, B:38:0x00fe, B:38:0x00fe), top: B:45:0x002d }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private com.discord.org.webrtc.VideoCodecStatus initEncodeInternal() {
        /*
            Method dump skipped, instruction units count: 320
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.discord.org.webrtc.HardwareVideoEncoder.initEncodeInternal():com.discord.org.webrtc.VideoCodecStatus");
    }
    ...
    private void updateInputFormat(MediaFormat mediaFormat) {
        ...
        rx1.u(i7, " isSemiPlanar: ", " frameSizeBytes: ", sb, zIsSemiPlanar);
        sb.append(i8);
    ...
    public void deliverEncodedImage() {
        ...
        try {
            ...
            if (!z || (byteBuffer = this.configBuffer) == null) {
                ...
                runnable = new Runnable() { // from class: com.discord.org.webrtc.c
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.i.lambda$deliverEncodedImage$0(iDequeueOutputBuffer);
                    }
                };
            } else {
    ...
    public VideoCodecStatus initEncode(VideoEncoder.Settings settings, VideoEncoder.Callback callback) {
        ...
        sb.append(" width: ");
        pk0.r(i3, i4, " height: ", " framerate_fps: ", sb);
        pk0.r(i5, i6, " bitrate_kbps: ", " surface mode: ", sb);
        sb.append(z);
        Logging.d(TAG, sb.toString());
        return initEncodeInternal();
    }
    ...
    public boolean isSemiPlanar(int i) {
        ...
        ff1.j(f33.h(i, "Unsupported colorFormat: "));
        return false;
    }

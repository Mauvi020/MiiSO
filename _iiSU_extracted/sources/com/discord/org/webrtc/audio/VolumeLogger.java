...
class VolumeLogger {
    ...
    public class LogVolumeTask extends TimerTask {
        ...
        public void run() {
            ...
            if (mode == 1) {
                Logging.d(VolumeLogger.TAG, j55.i("STREAM_RING stream volume: ", VolumeLogger.this.audioManager.getStreamVolume(2), " (max=", this.maxRingVolume, ")"));
            } else if (mode == 3) {
                Logging.d(VolumeLogger.TAG, j55.i("VOICE_CALL stream volume: ", VolumeLogger.this.audioManager.getStreamVolume(0), " (max=", this.maxVoiceCallVolume, ")"));
            }
        }
    }

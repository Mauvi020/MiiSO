...
import com.discord.org.webrtc.GlUtil;
import com.discord.org.webrtc.RendererCommon;
...
public class EglRenderer implements VideoSink {
    ...
    public EglRenderer(String str, VideoFrameDrawer videoFrameDrawer) {
        ...
        this.eglExceptionCallback = new Runnable() { // from class: com.discord.org.webrtc.EglRenderer.1
        ...
        this.logStatisticsRunnable = new Runnable() { // from class: com.discord.org.webrtc.EglRenderer.2
            @Override // java.lang.Runnable
            public void run() {
    ...
    private void swapBuffersOnRenderThread(final VideoFrame videoFrame, final long j) {
        synchronized (this.threadLock) {
            try {
                ...
                EglThread.RenderUpdate renderUpdate = new EglThread.RenderUpdate() { // from class: b62
                    @Override // com.discord.org.webrtc.EglThread.RenderUpdate
                    public final void update(boolean z) {
                        this.a.lambda$swapBuffersOnRenderThread$6(videoFrame, j, z);
                    }
                };
                boolean zIsPresent = this.id.isPresent();
                EglThread eglThread = this.eglThread;
                if (zIsPresent) {
                    eglThread.scheduleRenderUpdate(this.id.get(), renderUpdate);
                } else {
    ...
    public void addFrameListener(final FrameListener frameListener, final float f, final RendererCommon.GlDrawer glDrawer, final boolean z) {
        postToRenderThread(new Runnable() { // from class: z52
            @Override // java.lang.Runnable
            public final void run() {
                this.i.lambda$addFrameListener$1(glDrawer, frameListener, f, z);
            }
        });
    }
    ...
    public void clearImage(final float f, final float f2, final float f3, final float f4) {
        synchronized (this.threadLock) {
            try {
                ...
                eglThread.getHandler().postAtFrontOfQueue(new Runnable() { // from class: a62
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.i.lambda$clearImage$5(f, f2, f3, f4);
                    }
                });
            } catch (Throwable th) {
                throw th;
            ...
            try {
                ...
                synchronized (this.frameLock) {
                    try {
                        ...
                        videoFrame.retain();
                        this.eglThread.getHandler().post(new xa(22, this));
                    } finally {
                    }
                }
                if (z) {
    ...
    public void release() {
        ...
        synchronized (this.threadLock) {
            try {
                ...
                this.eglThread.getHandler().postAtFrontOfQueue(new tb(8, this, countDownLatch));
        ...
        synchronized (this.threadLock) {
            try {
                ...
                if (eglThread == null) {
                    ...
                    this.eglThread.getHandler().postAtFrontOfQueue(new tb(9, this, runnable));
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public void removeFrameListener(FrameListener frameListener) {
        ...
        synchronized (this.threadLock) {
            try {
                ...
                postToRenderThread(new of(this, countDownLatch, frameListener, 6));
                ThreadUtils.awaitUninterruptibly(countDownLatch);
            } catch (Throwable th) {
                throw th;
            }
    ...
    public void removeRenderListener(RenderListener renderListener) {
        ...
        synchronized (this.threadLock) {
            try {
                ...
                postToRenderThread(new of(this, countDownLatch, renderListener, 7));
                ThreadUtils.awaitUninterruptibly(countDownLatch);
            } catch (Throwable th) {
                throw th;
            }

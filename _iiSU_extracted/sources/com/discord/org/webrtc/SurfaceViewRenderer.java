...
public class SurfaceViewRenderer extends SurfaceView implements SurfaceHolder.Callback, VideoSink, RendererCommon.RendererEvents {
    ...
    private void updateSurfaceSize() {
        ...
        StringBuilder sbQ = j55.q("updateSurfaceSize. Layout size: ", width2, "x", height, ", frame size: ");
        pk0.r(i3, i4, "x", ", requested surface size: ", sbQ);
        pk0.r(iMin, iMin2, "x", ", old surface size: ", sbQ);
        sbQ.append(i5);
        sbQ.append("x");
        sbQ.append(i6);
        logD(sbQ.toString());
    ...
    @Override // com.discord.org.webrtc.RendererCommon.RendererEvents
    ...
    public void onMeasure(int i, int i2) {
        ...
        logD(f33.g(pointMeasure.x, pointMeasure.y, "onMeasure(). New size: ", "x"));
    }

...
public final class el6 implements InputConnection {
    public final wf7 a;
    ...
    public el6(ab8 ab8Var, wf7 wf7Var, boolean z) {
        this.a = wf7Var;
        this.b = z;
        this.d = ab8Var;
    }
    ...
    public final boolean b() {
        ...
        if (i == 0) {
            ...
            if (!arrayList.isEmpty()) {
                ((mb8) this.a.j).e.b(new ArrayList(arrayList));
                arrayList.clear();
            }
        }
        return this.c > 0;
    ...
    public final void closeConnection() {
        ...
        this.c = 0;
        this.h = false;
        ArrayList arrayList = ((mb8) this.a.j).i;
    ...
    public final CharSequence getSelectedText(int i) {
        ...
        return q28.g(this.d).j;
    }

    @Override // android.view.inputmethod.InputConnection
    public final CharSequence getTextAfterCursor(int i, int i2) {
        return q28.h(this.d, i).j;
    }

    @Override // android.view.inputmethod.InputConnection
    public final CharSequence getTextBeforeCursor(int i, int i2) {
        return q28.i(this.d, i).j;
    }
    ...
    */
    public final boolean requestCursorUpdates(int r10) {
        ...
        L77:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.el6.requestCursorUpdates(int):boolean");
    }
    ...
    public final boolean sendKeyEvent(KeyEvent keyEvent) {
        ...
        ((BaseInputConnection) ((mb8) this.a.j).j.getValue()).sendKeyEvent(keyEvent);
        return true;
    }

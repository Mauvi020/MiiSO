...
public final class tv7 {
    ...
    public tv7(float f, float f2, int i, int i2, int i3) {
        this.a = i;
        this.b = i2;
        this.c = f;
        this.d = f2;
    ...
    public final void f() {
        ...
        if (d2 > 1.00001d || d2 < 0.99999d) {
                ...
                while (true) {
                    ...
                    if (i15 > 0) {
                        ...
                        if (d > 1.0d) {
                            ...
                            this.l = sArrC2;
                            System.arraycopy(sArr3, i28 * i11, sArrC2, this.m * i11, i * i11);
                            e(i2, this.b, this.l, this.m + i, sArr3, i28 + i, sArr3, i28);
                            this.m += i29;
                            i14 = i28 + i2;
                        }
                    }
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    for (int i35 = 0; i35 < i11; i35++) {
                        ...
                        int i42 = i41 - i38;
                        int i43 = i41 - i40;
                        sArr5[i36] = (short) ((((i43 - i42) * s2) + (s * i42)) / i43);
                    }
                    this.q++;
                    this.m++;
                }
            ...
            short[] sArr7 = this.n;
            System.arraycopy(sArr7, i5 * i11, sArr7, 0, (i4 - i5) * i11);
            this.o -= i5;
            return;
        }
        a(this.j, 0, this.k);

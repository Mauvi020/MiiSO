...
public final class b26 {
    ...
    public static void b(b26[] b26VarArr, Path path) {
        int i;
        float[] fArr;
        int i2;
        b26 b26Var;
        ...
        float f9;
        float f10;
        b26[] b26VarArr2 = b26VarArr;
        Path path2 = path;
        float[] fArr2 = new float[6];
        int length = b26VarArr2.length;
        int i4 = 0;
        int i5 = 0;
        char c2 = 'm';
        while (i5 < length) {
            b26 b26Var3 = b26VarArr2[i5];
            char c3 = b26Var3.a;
            float[] fArr3 = b26Var3.b;
            float f11 = fArr2[i4];
            float f12 = fArr2[1];
            float f13 = fArr2[2];
            float f14 = fArr2[3];

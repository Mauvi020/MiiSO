...
public final class vw8 {
    public static final yl6 v = new yl6(1);
    public int a;
    public final int b;
    public float[] d;
    public float[] e;
    ...
    public int c = -1;
    public final ta u = new ta(18, this);

    public vw8(Context context, CoordinatorLayout coordinatorLayout, t28 t28Var) {
        if (t28Var == null) {
            ff1.j("Callback may not be null");
            throw null;
        }
    ...
    */
    public final boolean c(android.view.View r4, float r5, float r6) {
        ...
        L41:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.vw8.c(android.view.View, float, float):boolean");
    }
    ...
    public final boolean h(int i, int i2, int i3, int i4) {
        ...
        float f6 = f3 / f4;
        t28 t28Var = this.q;
        overScroller.startScroll(left, top, i5, i6, (int) ((e(i6, i4, t28Var.i()) * f6) + (e(i5, i3, t28Var.h(view)) * f5)));
        n(2);
        return true;
    }
    ...
    public final void j(MotionEvent motionEvent) {
        ...
        if (this.a == 1) {
            if (i(this.c)) {
                ...
                if (i8 != 0) {
                    left = t28Var.b(this.r, left);
                    int[] iArr = pw8.a;
                    this.r.offsetLeftAndRight(left - left2);
                }
                if (i9 != 0) {
                    top = t28Var.c(this.r, top);
                    int[] iArr2 = pw8.a;
                    this.r.offsetTopAndBottom(top - top2);
                }
                if (i8 != 0 || i9 != 0) {
                    t28Var.m(this.r, left, top);
                }
                m(motionEvent);
                return;
            }
    ...
    public final boolean o(int i, int i2) {
        ...
        ff1.n("Cannot settleCapturedViewAt outside of a call to Callback#onViewReleased");
        return false;
    }
    ...
    */
    public final boolean p(android.view.MotionEvent r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.vw8.p(android.view.MotionEvent):boolean");
    }

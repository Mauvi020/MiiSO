...
public final class zi4 extends gu0 {
    public final /* synthetic */ int d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ zi4(long j, String str, int i, int i2) {
        super(i, j, str);
        this.d = i2;
    }
    ...
    public final float e(float f, float f2, float f3) {
        switch (this.d) {
            case 0:
                ...
                return (f4 > 0.20689656f ? f4 * f4 * f4 : 0.12841855f * (f4 - 0.13793103f)) * df1.j[2];
            default:
                if (f3 < -2.0f) {
                    f3 = -2.0f;
                }
    ...
    public final long f(float f, float f2, float f3, float f4, gu0 gu0Var) {
        switch (this.d) {
            case 0:
                ...
                return v80.f(f8, f9, f10 <= 128.0f ? f10 : 128.0f, f4, gu0Var);
            default:
                if (f < -2.0f) {
                    f = -2.0f;
                }
                ...
                return v80.f(f, f2, f3 <= 2.0f ? f3 : 2.0f, f4, gu0Var);
        }
    }
}

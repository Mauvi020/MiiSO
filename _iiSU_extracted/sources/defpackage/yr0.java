...
public final class yr0 {
    ...
    public yr0(TextInputLayout textInputLayout) {
    ...
    public final boolean b(CharSequence charSequence) {
        ...
        if (this.D) {
            return (z ? n98.d : n98.c).d(charSequence, charSequence.length());
        }
        return z;
    }
    ...
    public final void g(Configuration configuration) {
        if (Build.VERSION.SDK_INT >= 31) {
            ...
            if (typeface != null) {
                this.s = ny7.r(configuration, typeface);
            }
            Typeface typeface2 = this.w;
            if (typeface2 != null) {
                this.v = ny7.r(configuration, typeface2);
            }
    ...
    public final void h(boolean z) {
        ...
        l(f);
        zc2 zc2Var = si.b;
        this.a0 = 1.0f - f(0.0f, 1.0f, 1.0f - f, zc2Var);
        int[] iArr = pw8.a;
        textInputLayout.postInvalidateOnAnimation();
        this.b0 = f(1.0f, 0.0f, f, zc2Var);
        textInputLayout.postInvalidateOnAnimation();
        ...
        float f4 = this.W;
        if (f3 != f4) {
            textPaint.setLetterSpacing(f(f4, f3, f, zc2Var));
        } else {
            textPaint.setLetterSpacing(f3);
        }
        this.H = si.a(0.0f, this.R, f);
        this.I = si.a(0.0f, this.S, f);
        this.J = si.a(0.0f, this.T, f);
    ...
    public final boolean j(Typeface typeface) {
        ...
        this.t = typeface;
        Typeface typefaceR = ny7.r(this.a.getContext().getResources().getConfiguration(), typeface);
        this.s = typefaceR;
        if (typefaceR == null) {
            typefaceR = this.t;
        }
    ...
    public final void k(float f) {
        ...
        if (f != this.b) {
            ...
            float f5 = this.W;
            if (f4 != f5) {
                textPaint.setLetterSpacing(f(f5, f4, f, zc2Var));
            } else {

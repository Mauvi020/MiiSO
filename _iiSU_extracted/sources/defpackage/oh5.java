...
public abstract class oh5 {
    ...
    private static final void c(int i, int i2) {
        throw new IndexOutOfBoundsException(j55.i("Index ", i, " is out of bounds. The list has ", i2, " elements."));
    }

    private static final void d(int i) {
        throw new IndexOutOfBoundsException(j55.h("fromIndex (", i, ") is less than 0."));
    }
    ...
    private static final void f(int i, int i2) {
        throw new IllegalArgumentException(j55.i("Indices are out of order. fromIndex (", i, ") is greater than toIndex (", i2, ")."));
    }
}

...
public final class au7 {
    ...
    public au7(xt7 xt7Var) {
        this.a = xt7Var;
        int[] iArr = xt7Var.i;
        this.b = iArr;
        Object[] objArr = xt7Var.k;
        this.c = objArr;
        this.d = xt7Var.q;
        this.e = xt7Var.r;
        this.f = xt7Var.s;
    ...
    public static void z(au7 au7Var) {
        int i = au7Var.v;
        int iR = au7Var.r(i);
        int[] iArr = au7Var.b;
        int i2 = (iR * 5) + 1;
        ...
        au7Var.T(au7Var.E(iArr, i));
    }

    public final void A(xt7 xt7Var, int i) {
        if (this.n <= 0) {
            ly0.a("Check failed");
        }
        if (i == 0 && this.t == 0 && this.a.j == 0) {
            int[] iArr = xt7Var.i;
            int i2 = iArr[(i * 5) + 3];
            int i3 = xt7Var.j;
            if (i2 == i3) {
                ...
                HashMap map = this.e;
                kg5 kg5Var = this.f;
                Object[] objArr2 = xt7Var.k;
                int i4 = xt7Var.l;
                HashMap map2 = xt7Var.r;
                kg5 kg5Var2 = xt7Var.s;
                this.b = iArr;
                this.c = objArr2;
                this.d = xt7Var.q;
                this.g = i3;
        ...
        try {
            cj2.e0(au7VarI, i, this, true, true, false);
            au7VarI.e(true);
        } catch (Throwable th) {
            au7VarI.e(false);
            throw th;
    ...
    public final void B(int i) {
        ...
        if (i6 != i) {
            if (!this.d.isEmpty()) {
                ...
                ArrayList arrayList = this.d;
                if (i6 < i) {
                    for (int iA = zt7.a(arrayList, i6, iO); iA < this.d.size() && (i3 = (r9Var2 = (r9) this.d.get(iA)).a) < 0 && (i4 = i3 + iO) < i; iA++) {
                        r9Var2.a = i4;
                    }
                } else {
                    for (int iA2 = zt7.a(arrayList, i, iO); iA2 < this.d.size() && (i2 = (r9Var = (r9) this.d.get(iA2)).a) >= 0; iA2++) {
                        r9Var.a = -(iO - i2);
                    }
                }
            }
            if (i5 > 0) {
                ...
                int i9 = i6 * 5;
                if (i < i6) {
                    ap.y0(i8 + i7, i7, i9, iArr, iArr);
                } else {
                    ap.y0(i9, i9 + i8, i7 + i8, iArr, iArr);
                }
            }
            if (i < i6) {
                i6 = i + i5;
        ...
        if (i5 != iMin) {
            ...
            if (iMin < i5) {
                ...
                while (iR < iR2) {
                    ...
                    int i9 = this.b[i8];
                    if (i9 < 0) {
                        ly0.a("Unexpected anchor value, expected a positive anchor");
                    }
                ...
                while (iR3 < iR4) {
                    ...
                    int i11 = this.b[i10];
                    if (i11 >= 0) {
                        ly0.a("Unexpected anchor value, expected a negative anchor");
                    }
    ...
    public final Object F(Object obj) {
        ...
        if (this.i > this.j) {
            ly0.a("Writing to an invalid slot");
        }
    ...
    public final boolean H() {
        if (this.n != 0) {
            ly0.a("Cannot remove group while inserting");
        }
        int i = this.t;
        int i2 = this.i;
        int iG = g(this.b, r(i));
    ...
    public final boolean I(int i, int i2) {
        if (i2 > 0) {
            ...
            if (!arrayList.isEmpty()) {
                HashMap map = this.e;
                int i3 = i + i2;
                int iA = zt7.a(this.d, i3, o() - this.h);
                if (iA >= this.d.size()) {
                    iA--;
                }
                int i4 = iA + 1;
                int i5 = 0;
                while (iA >= 0) {
                    r9 r9Var = (r9) this.d.get(iA);
                    int iC = c(r9Var);
                    if (iC < i) {
                        break;
                    }
                    if (iC < i3) {
                        r9Var.a = Integer.MIN_VALUE;
                        if (map != null) {
                        }
                        if (i5 == 0) {
                            i5 = iA + 1;
    ...
    public final Object K(int i, Object obj, int i2) {
        ...
        int i3 = iN + i2;
        if (i3 < iN || i3 >= iG) {
            ly0.a("Write to an invalid slot index " + i2 + " for group " + i);
        }
        int iH = h(i3);
        Object[] objArr = this.c;
    ...
    public final ay2 O(int i) {
        r9 r9VarR;
        HashMap map = this.e;
        if (map == null || (r9VarR = R(i)) == null) {
            return null;
        }
        return (ay2) map.get(r9VarR);
    }

    public final void P() {
        if (this.n != 0) {
            ly0.a("Key must be supplied when inserting");
        }
        fj7 fj7Var = ey0.a;
        Q(fj7Var, fj7Var, false, 0);
    }
    ...
    public final void Q(Object obj, Object obj2, boolean z, int i) {
        ...
        if (objArr == true) {
            ...
            this.j = iG;
            int iR = r(i4);
            int i5 = obj != fj7Var ? 1 : 0;
            int i6 = (z || obj2 == fj7Var) ? 0 : 1;
    ...
    public final r9 R(int i) {
        ArrayList arrayList;
        int iD;
        if (i < 0 || i >= p() || (iD = zt7.d((arrayList = this.d), i, p())) < 0) {
            return null;
        }
    ...
    public final void S(Object obj) {
        ...
        if ((this.b[i] & 268435456) == 0) {
            ly0.a("Updating the data of a group that was not created with a data slot");
        }
        Object[] objArr = this.c;
        int[] iArr = this.b;
    ...
    public final void U(int i, Object obj) {
        ...
        if (iR >= iArr.length || (iArr[(iR * 5) + 1] & 1073741824) == 0) {
            ly0.a("Updating the node of a group at " + i + " that was not created with as a node group");
        }
    ...
    public final void a(int i) {
        if (i < 0) {
            ly0.a("Cannot seek backwards");
        }
        if (this.n > 0) {
            ua6.b("Cannot call seek() while inserting");
        }
        if (i == 0) {
            return;
        }
        ...
        if (i2 < this.v || i2 > this.u) {
            ly0.a("Cannot seek outside the current group (" + this.v + '-' + this.u + ')');
        }
        this.t = i2;
    ...
    public final r9 b(int i) {
        ArrayList arrayList = this.d;
        int iD = zt7.d(arrayList, i, p());
        if (iD >= 0) {
            return (r9) arrayList.get(iD);
        }
        if (i > this.g) {
    ...
    public final void j() {
        ...
        if (z) {
            kg5 kg5Var = this.s;
            if (kg5Var != null && (wg5Var = (wg5) kg5Var.b(i3)) != null) {
        ...
        if (i != i2) {
            ly0.a("Expected to be at the end of a group");
        }
        int[] iArr2 = this.b;
        int i10 = i6 + 3;
        int i11 = iArr2[i10];
        ...
        if (i13 != 0 || i14 != 0) {
            while (iE2 != 0 && iE2 != iB2 && (i14 != 0 || i13 != 0)) {
                ...
                if (i14 != 0) {
                    int[] iArr4 = this.b;
                    zt7.c(iR2, (iArr4[(iR2 * 5) + 1] & 67108863) + i14, iArr4);
                }
                int[] iArr5 = this.b;
    ...
    public final void k() {
        if (this.n <= 0) {
            ua6.b("Unbalanced begin/end insert");
        }
        int i = this.n - 1;
        this.n = i;
        if (i == 0) {
            if (this.r.b != this.p.b) {
                ly0.a("startGroup/endGroup mismatch while inserting");
            }
            this.u = (o() - this.h) - this.q.b();
        }
    }
    ...
    public final void l(int i) {
        boolean z = false;
        if (!(this.n <= 0)) {
            ly0.a("Cannot call ensureStarted() while inserting");
        }
        int i2 = this.v;
        if (i2 != i) {
            if (i >= i2 && i < this.u) {
            ...
            if (!z) {
                ly0.a("Started group at " + i + " must be a subgroup of the group at " + i2);
            }
            int i3 = this.t;
            int i4 = this.i;
            int i5 = this.j;
    ...
    */
    public final void n(int r20, defpackage.ks2 r21) {
        /*
            Method dump skipped, instruction units count: 315
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.au7.n(int, ks2):void");
    }
    ...
    public final boolean v(int i, int i2) {
        ...
        if (i2 == this.v) {
            ...
            if (i2 > xd4Var.a(0)) {
                ...
                int[] iArr = xd4Var.a;
                int iMin = Math.min(iArr.length, xd4Var.b);
                int i3 = 0;
                while (true) {
                    if (i3 >= iMin) {
                        i3 = -1;
    ...
    public final void w(int i) {
        if (i > 0) {
            ...
            if (i4 < i) {
                ...
                int i6 = iMax - i5;
                ap.y0(0, 0, i3 * 5, iArr, iArr2);
                ap.y0((i3 + i6) * 5, (i4 + i3) * 5, length * 5, iArr, iArr2);
                this.b = iArr2;
                i4 = i6;
            }
            int i7 = this.u;

...
public final class o88 {
    ...
    public o88(Context context, int i) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(i, wi6.s);
        this.k = typedArrayObtainStyledAttributes.getDimension(0, 0.0f);
        this.j = mk2.m(context, typedArrayObtainStyledAttributes, 3);
        mk2.m(context, typedArrayObtainStyledAttributes, 4);
        mk2.m(context, typedArrayObtainStyledAttributes, 5);
        ...
        this.a = mk2.m(context, typedArrayObtainStyledAttributes, 6);
        ...
        TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(i, wi6.l);
    ...
    public final Typeface b(Context context) {
        ...
        if (!context.isRestricted()) {
            try {
                Typeface typefaceA = xq6.a(context, this.l);
                this.n = typefaceA;
                if (typefaceA != null) {
    ...
    public final void c(Context context, px7 px7Var) {
        if (d(context)) {
            b(context);
        } else {
            a();
        ...
        if (this.m) {
            px7Var.v(this.n, true);
            return;
        }
        try {
            m88 m88Var = new m88(this, px7Var);
            ThreadLocal threadLocal = xq6.a;
            if (context.isRestricted()) {
                m88Var.p(-4);
            } else {
                xq6.b(context, i, new TypedValue(), 0, m88Var, false, false);
            }
    ...
    public final boolean d(Context context) {
        ...
        if (i != 0) {
            ThreadLocal threadLocal = xq6.a;
            if (!context.isRestricted()) {
                typefaceB = xq6.b(context, i, new TypedValue(), 0, null, false, true);
            }
        }
        return typefaceB != null;
    }

    public final void e(Context context, TextPaint textPaint, px7 px7Var) {
        f(context, textPaint, px7Var);
    ...
    public final void f(Context context, TextPaint textPaint, px7 px7Var) {
        if (d(context)) {
        ...
        c(context, new n88(this, context, textPaint, px7Var));
    }

    public final void g(Context context, TextPaint textPaint, Typeface typeface) {
        Typeface typefaceR = ny7.r(context.getResources().getConfiguration(), typeface);
        if (typefaceR != null) {
            typeface = typefaceR;
        }

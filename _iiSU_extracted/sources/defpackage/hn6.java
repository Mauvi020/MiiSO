...
public abstract class hn6 {
    ...
    public static void e(AccessibleObject accessibleObject) {
        try {
            ...
            throw new tg4(pk0.j("Failed making ", d(accessibleObject, false), " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type."), e);
        }
    }
}

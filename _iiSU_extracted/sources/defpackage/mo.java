...
public final class mo implements vo {
    ...
    public final void clear() {
        int i = this.h;
        for (int i2 = 0; i != -1 && i2 < this.a; i2++) {
            rv7 rv7Var = ((rv7[]) this.c.l)[this.e[i]];
            if (rv7Var != null) {
                rv7Var.b(this.b);
            }
            i = this.f[i];
    ...
    public final float i(wo woVar, boolean z) {
        ...
        for (int i = 0; i < iC; i++) {
            ...
            e(rv7VarD, voVar.a(rv7VarD) * fA, z);
        }
        return fA;
    }
    ...
    public final String toString() {
        ...
        for (int i2 = 0; i != -1 && i2 < this.a; i2++) {
            ...
            sb.append(strConcat);
            str = rx1.s(sb, this.g[i], " : ") + ((rv7[]) this.c.l)[this.e[i]];
            i = this.f[i];
        }
        return str;
    }

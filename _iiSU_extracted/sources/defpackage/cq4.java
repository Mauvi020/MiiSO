...
public final class cq4 {
    ...
    public cq4(CharSequence charSequence, TextPaint textPaint, int i) {
        this.a = charSequence;
        this.b = textPaint;
        this.c = i;
    }
    ...
    public final BoringLayout.Metrics a() {
        if (!this.g) {
            TextDirectionHeuristic textDirectionHeuristicB = zb8.b(this.c);
    ...
    public final CharSequence b() {
        ...
        if (charSequence2 instanceof Spanned) {
            ...
            if (ys8.j(spanned, CharacterStyle.class)) {
    ...
    */
    public final float c() {
        ...
        L39:
            ...
            java.lang.Class<dv4> r4 = defpackage.dv4.class
            boolean r4 = defpackage.ys8.j(r2, r4)
            if (r4 != 0) goto L5a
            java.lang.Class<cv4> r4 = defpackage.cv4.class
            boolean r2 = defpackage.ys8.j(r2, r4)
            if (r2 != 0) goto L5a
        L51:
        ...
        L5d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.cq4.c():float");
    }
}

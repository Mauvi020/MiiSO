...
public abstract class hi2 {
    ...
    public static final sl6 a(View view, View view2) {
        int[] iArr = a;
        ...
        return new sl6(f2, r1.top + f, r1.width() + f2, f + r1.top + r1.height());
    }
    ...
    public static final boolean b(View view, Integer num, Rect rect) {
        ...
        if (view instanceof wa) {
            return ((wa) view).requestFocus(num.intValue(), rect);
        }
        if (rect != null) {
    ...
    public static final uh2 d(int i) {
        if (i == 1) {
            return new uh2(2);
        }
        if (i == 2) {

...
public final class z91 extends ViewGroup.MarginLayoutParams {
    public w91 a;
    public boolean b;
    public final int c;
    public final int d;
    ...
    public z91(Context context, AttributeSet attributeSet) {
        ...
        this.h = 0;
        this.o = new Rect();
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, ri6.b);
        ...
        if (zHasValue) {
            ...
            if (!TextUtils.isEmpty(string)) {
                ...
                try {
                    ...
                    w91Var = (w91) constructor.newInstance(context, attributeSet);
                } catch (Exception e) {
                    pl5.q("Could not inflate Behavior subclass ".concat(string), e);
                    throw null;
                }
            }
            this.a = w91Var;
    ...
    public z91(z91 z91Var) {
        super((ViewGroup.MarginLayoutParams) z91Var);
        this.b = false;
        this.c = 0;
        this.d = 0;
        this.e = -1;
    ...
    public z91(ViewGroup.MarginLayoutParams marginLayoutParams) {
    ...
    public z91(ViewGroup.LayoutParams layoutParams) {
        super(layoutParams);
        this.b = false;
        this.c = 0;
        this.d = 0;

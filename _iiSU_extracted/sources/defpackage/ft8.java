...
public abstract class ft8 {
    ...
    public static boolean A(Context context) {
        ...
        String str = d;
        return zz1.x(str, "moto g(20)") || zz1.x(str, "rmx3231");
    }

    public static boolean B() {
        String strC0 = zz1.c0(b);
        return strC0.contains("emulator") || strC0.contains("emu64a") || strC0.contains("generic");
    }
    ...
    public static String D(Context context, String str) {
        ...
        try {
            ...
            String strL = l(M(inputStreamOpen));
            try {
    ...
    public static String F(String str) {
        ...
        if (str4 != null) {
            strC0 = str4.concat(strC0.substring(str2.length()));
            str2 = str4;
        }
        ...
        while (true) {
            ...
            if (strC0.startsWith(strArr2[i2])) {
                return strArr2[i2 + 1] + strC0.substring(strArr2[i2].length());
            }
            i2 += 2;
        }
    }
    ...
    public static long I(long j2, int i2) {
        return K(j2, 1000000L, i2, RoundingMode.FLOOR);
    }
    ...
    public static void J(long[] jArr, long j2) {
        ...
        if (j2 >= 1000000 && j2 % 1000000 == 0) {
            long jV = fm2.v(j2, 1000000L, RoundingMode.UNNECESSARY);
            while (i2 < jArr.length) {
                jArr[i2] = fm2.v(jArr[i2], jV, roundingMode);
                i2++;
            }
            return;
        }
        if (j2 < 1000000 && 1000000 % j2 == 0) {
            long jV2 = fm2.v(1000000L, j2, RoundingMode.UNNECESSARY);
            while (i2 < jArr.length) {
                jArr[i2] = fm2.i0(jArr[i2], jV2);
                i2++;
            }
            return;
        }
        ...
        while (i3 < jArr.length) {
            ...
            if (j4 != 0) {
                if (j2 >= j4 && j2 % j4 == 0) {
                    jArr[i3] = fm2.v(1000000L, fm2.v(j2, j4, RoundingMode.UNNECESSARY), roundingMode);
                } else if (j2 >= j4 || j4 % j2 != 0) {
                    j3 = j2;
                    jArr[i3] = L(j4, 1000000L, j3, roundingMode);
                } else {
                    jArr[i3] = fm2.i0(1000000L, fm2.v(j4, j2, RoundingMode.UNNECESSARY));
                }
                j3 = j2;
            } else {
                j3 = j2;
    ...
    public static long K(long j2, long j3, long j4, RoundingMode roundingMode) {
        if (j2 == 0 || j3 == 0) {
            return 0L;
        }
        return (j4 < j3 || j4 % j3 != 0) ? (j4 >= j3 || j3 % j4 != 0) ? (j4 < j2 || j4 % j2 != 0) ? (j4 >= j2 || j2 % j4 != 0) ? L(j2, j3, j4, roundingMode) : fm2.i0(j3, fm2.v(j2, j4, RoundingMode.UNNECESSARY)) : fm2.v(j3, fm2.v(j4, j2, RoundingMode.UNNECESSARY), roundingMode) : fm2.i0(j2, fm2.v(j3, j4, RoundingMode.UNNECESSARY)) : fm2.v(j2, fm2.v(j4, j3, RoundingMode.UNNECESSARY), roundingMode);
    }
    ...
    */
    public static long L(long r9, long r11, long r13, java.math.RoundingMode r15) {
        /*
            Method dump skipped, instruction units count: 320
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ft8.L(long, long, long, java.math.RoundingMode):long");
    }
    ...
    public static Handler k(a85 a85Var) {
        Looper looperMyLooper = Looper.myLooper();
        xe4.L(looperMyLooper);
        return new Handler(looperMyLooper, a85Var);
    }

    public static String l(byte[] bArr) {
        return new String(bArr, jp0.c);
    }
    ...
    */
    public static int o(int r2) {
        ...
        L28:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ft8.o(int):int");
    }
    ...
    public static String u(String str) {
        try {
            ...
            v80.r0("Util", "Failed to read system property ".concat(str), e2);
            return null;
        }
    }
    ...
    public static String v(int i2) {
        switch (i2) {
            ...
            default:
                return i2 >= 10000 ? j55.h("custom (", i2, ")") : "?";
        }
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static int w(android.net.Uri r7, java.lang.String r8) {
        /*
            Method dump skipped, instruction units count: 278
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ft8.w(android.net.Uri, java.lang.String):int");
    }

    public static boolean x(t06 t06Var, t06 t06Var2, Inflater inflater) {
        if (t06Var.a() <= 0) {
            return false;
        }
        if (t06Var2.a.length < t06Var.a()) {
            t06Var2.b(t06Var.a() * 2);
        }
        if (inflater == null) {
            inflater = new Inflater();
        }
        inflater.setInput(t06Var.a, t06Var.b, t06Var.a());
        int iInflate = 0;
        while (true) {
            try {
                byte[] bArr = t06Var2.a;

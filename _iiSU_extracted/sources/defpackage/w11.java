...
public abstract class w11 {
    public static final long a(int i, int i2, int i3, int i4) {
        if (!((i3 >= 0) & (i2 >= i) & (i4 >= i3) & (i >= 0))) {
            xb4.a("maxWidth must be >= than minWidth,\nmaxHeight must be >= than minHeight,\nminWidth and minHeight must be >= 0");
        }
        return h(i, i2, i3, i4);
    }
    ...
    public static final void k(int i, int i2) {
        throw new IllegalArgumentException(j55.i("Can't represent a width of ", i, " and height of ", i2, " in Constraints"));
    }

    public static final Void l(int i) {
        throw new IllegalArgumentException(j55.h("Can't represent a size of ", i, " in Constraints"));
    }
}

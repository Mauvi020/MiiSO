...
public final class on0 {
    ...
    public final void b() {
        ...
        if (length > 0) {
            ...
            for (int size = arrayList.size() - 1; size >= 0; size--) {
                nn0 nn0Var = (nn0) arrayList.get(size);
                int i = nn0Var.c;
                if (i != length) {
                    return;
                }
    ...
    public final kc1 c(int i) {
        ...
        return new kc1(spannableStringBuilder, Layout.Alignment.ALIGN_NORMAL, null, null, i6, 1, Integer.MIN_VALUE, f, i5, Integer.MIN_VALUE, -3.4028235E38f, -3.4028235E38f, -3.4028235E38f, false, -16777216, Integer.MIN_VALUE, 0.0f);
    }
    ...
    public final SpannableString d() {
        ...
        while (true) {
            ...
            nn0 nn0Var = (nn0) arrayList.get(i5);
            boolean z2 = nn0Var.b;
            int i7 = nn0Var.a;
            if (i7 != 8) {
                boolean z3 = i7 == 7;
            ...
            int i8 = nn0Var.c;
            i5++;
            if (i8 != (i5 < arrayList.size() ? ((nn0) arrayList.get(i5)).c : length)) {
                if (i != -1 && !z2) {

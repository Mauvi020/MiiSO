...
public final class i3 {
    ...
    public i3(AccessibilityNodeInfo accessibilityNodeInfo) {
    ...
    public final void b(g3 g3Var) {
        this.a.addAction((AccessibilityNodeInfo.AccessibilityAction) g3Var.a);
    }
    ...
    public final CharSequence g() {
        ...
        for (int i = 0; i < arrayListC.size(); i++) {
            spannableString.setSpan(new u2(((Integer) arrayListC4.get(i)).intValue(), this, accessibilityNodeInfo.getExtras().getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ACTION_ID_KEY")), ((Integer) arrayListC.get(i)).intValue(), ((Integer) arrayListC2.get(i)).intValue(), ((Integer) arrayListC3.get(i)).intValue());
        }
    ...
    public final String toString() {
        ...
        if (i >= 34) {
            x2.c(accessibilityNodeInfo, rect);
        } else {
        ...
        sb.append("; uniqueId: ");
        sb.append(i >= 33 ? h3.d(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getString("androidx.view.accessibility.AccessibilityNodeInfoCompat.UNIQUE_ID_KEY"));
        sb.append("; checkable: ");
        ...
        sb.append(i >= 34 ? x2.d(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getCharSequence("androidx.view.accessibility.AccessibilityNodeInfoCompat.CONTAINER_TITLE_KEY"));
        ...
        sb.append(i >= 33 ? h3.e(accessibilityNodeInfo) : e(8388608));
        sb.append("; accessibilityDataSensitive: ");
        sb.append(i >= 34 ? x2.g(accessibilityNodeInfo) : e(64));
        sb.append("; [");
        List<AccessibilityNodeInfo.AccessibilityAction> actionList = accessibilityNodeInfo.getActionList();
        ArrayList arrayList = new ArrayList();
        int size = actionList.size();
        for (int i2 = 0; i2 < size; i2++) {
            arrayList.add(new g3(actionList.get(i2), 0, null, null, null));
        }
        for (int i3 = 0; i3 < arrayList.size(); i3++) {
            g3 g3Var = (g3) arrayList.get(i3);
            int iA = g3Var.a();
            Object obj = g3Var.a;
            String strD = d(iA);

...
public final class jl5 {
    ...
    public jl5(ViewGroup viewGroup) {
        this.c = viewGroup;
    }
    ...
    public final boolean c(int i, int i2, int i3, int[] iArr, int[] iArr2) {
        ...
        iArr3[0] = 0;
        iArr3[1] = 0;
        if (viewParentE instanceof kl5) {
            ((kl5) viewParentE).h(viewGroup, i, i2, iArr3, i3);
            viewGroup = viewGroup;
        } else if (i3 == 0) {
            try {
    ...
    public final boolean d(int i, int i2, int i3, int i4, int[] iArr, int i5, int[] iArr2) {
        ...
        if (this.d && (viewParentE = e(i5)) != null) {
            if (i != 0 || i2 != 0 || i3 != 0 || i4 != 0) {
                ...
                if (viewParentE instanceof ll5) {
                    ((ll5) viewParentE).c(viewGroup, i, i2, i3, i4, i5, iArr3);
                } else {
                    iArr3[0] = iArr3[0] + i3;
                    iArr3[1] = iArr3[1] + i4;
                    if (viewParentE instanceof kl5) {
                        ((kl5) viewParentE).d(viewGroup, i, i2, i3, i4, i5);
                    } else if (i5 == 0) {
                        try {
        ...
        if (!f(i2)) {
            if (this.d) {
                ...
                for (ViewParent parent = view.getParent(); parent != null; parent = parent.getParent()) {
                    boolean z = parent instanceof kl5;
                    if (z) {
                        zOnStartNestedScroll = ((kl5) parent).e(view2, view, i, i2);
                    } else if (i2 == 0) {
                        try {
    ...
    public final void h(int i) {
        ...
        if (viewParentE != null) {
            boolean z = viewParentE instanceof kl5;
            ViewGroup viewGroup = this.c;
            if (z) {
                ((kl5) viewParentE).g(viewGroup, i);
            } else if (i == 0) {
                try {

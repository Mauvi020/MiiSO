...
public final /* synthetic */ class j35 extends vs2 implements ur2 {
    public final /* synthetic */ int p;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public j35(MainActivity mainActivity) {
        super(0, mainActivity, MainActivity.class, "handleOverlayTouchDismissFromPresentation", "handleOverlayTouchDismissFromPresentation()Z", 0, 0);
        this.p = 6;
    }
    ...
    public final Object a() {
        ...
        switch (i) {
            ...
            case 1:
                ...
                xe4.n0(kj2.V(mainActivity), null, null, new p25(mainActivity, null, 12), 3);
                break;
            case 2:
            ...
            case 5:
                ...
                mainActivity2.U1(mainActivity2.v0, mainActivity2.w0, (ue6) mainActivity2.k0().d.i.getValue());
                break;
            case 6:
                break;
            case 7:
            ...
            default:
                ...
                try {
                    mainActivity3.startActivity(new Intent("android.settings.WIFI_SETTINGS").addFlags(268435456));
                    hr6Var = gq8Var;
                } catch (Throwable th) {
                    hr6Var = new hr6(th);
                }
                ...
                if (thA != null) {
                    Log.w("MainActivity", "Unable to open WiFi settings", thA);
                }
                break;
        }
        return gq8Var;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ j35(int i, Object obj, Class cls, String str, String str2, int i2, int i3, int i4) {

...
public final class vm6 extends w2 {
    public final RecyclerView l;
    public final um6 m;

    public vm6(RecyclerView recyclerView) {
        this.l = recyclerView;
        um6 um6Var = this.m;
        if (um6Var != null) {
            this.m = um6Var;
    ...
    public final void c(View view, AccessibilityEvent accessibilityEvent) {
        ...
        if (!(view instanceof RecyclerView) || this.l.t()) {
            return;
        }
    ...
    public final void d(View view, i3 i3Var) {
        ...
        gm6 layoutManager = recyclerView.getLayoutManager();
        RecyclerView recyclerView2 = layoutManager.b;
        layoutManager.F(recyclerView2.j, recyclerView2.h0, i3Var);
    }
    ...
    */
    public final boolean g(android.view.View r5, int r6, android.os.Bundle r7) {
        ...
        L8:
            ...
            r0 = 0
            if (r5 != 0) goto Lad
            gm6 r5 = r4.getLayoutManager()
            if (r5 == 0) goto Lad
            gm6 r4 = r4.getLayoutManager()
        ...
        Lad:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.vm6.g(android.view.View, int, android.os.Bundle):boolean");
    }
}
